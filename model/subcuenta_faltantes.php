...
/**
 * Subcuentas asociadas a los faltantes de Distribucion
 */
class subcuenta_faltantes extends fs_model
{
   public function __construct($c=FALSE)
   {
      parent::__construct('subcuenta_faltantes', 'plugins/distribucion/');
      if($c)
      {
   ...
   public function get_subcuenta($ejercicio)
   {
      ...
      if(!$subcuenta)
      {
         ...
         if($ccli)
         {
            ...
            if($continuar)
            {
               $sccli = new distribucion_subcuentas_faltantes();
