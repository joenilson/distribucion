...
require_once 'plugins/distribucion/extras/fpdf181/fpdf.php';
...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        if ($this->fdf_verlogotipo == '1')
        {
            ...
            $this->Image($this->logo,$this->fdf_Xlogotipo,$this->fdf_Ylogotipo,40);
            $this->Ln(0);
        }
    ...
    function datos_documento($documento, $tipo_documento, $estado){
        ...
        $codigo  = 'Facturación: '.$documento->codigo;
        $ncf  = ucfirst(FS_NUMERO2).': - '.$documento->ncf;
        $szfont = 9;
        $loop   = 0;
